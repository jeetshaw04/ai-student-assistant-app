...
The user captures an image using the mobile camera.


The app detects the object using an on-device vision model.


The detected object is sent to an LLM to generate a translated word and a simple example sentence.


The result is displayed and pronounced using text-to-speech.


The study planner generates schedules based on user input such as subjects and difficulty levels.
